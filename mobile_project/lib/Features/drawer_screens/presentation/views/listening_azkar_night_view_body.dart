...
class ListeningAzkarNightViewBody extends StatefulWidget {
  @override
  State<ListeningAzkarNightViewBody> createState() =>
      _ListeningAzkarNightViewBodyState();
}
...
class _ListeningAzkarNightViewBodyState
    extends State<ListeningAzkarNightViewBody> {
  @override
  void initState() {
    super.initState();
    _audioPlayer.open(
      Audio("assets/audio/azkar2.mp3"),
    );
  }
